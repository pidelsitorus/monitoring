        ...
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                <button data-dropdown
                    ...
                    <span class="ml-4 text-sm hidden md:inline-block">{{ auth()->user()->email }}</span>
            ...
            <div class="sidebar text-center bg-gray-900">
                <div class="text-gray-100 text-xl">
                    <div class="p-2.5 mt-1 flex items-center">
                        ...
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3"><a
                                href="{{ route('admin.dashboard') }}">Admin</h1>
                    </div>
                ...
                <a href="{{ route('devices') }}">
                    <div
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Data Pemeriksaan</span>
                    </div>
                </a>
                ...
                <a href="{{ route('hasils') }}">
                    <div
                        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Hasil Pemeriksaan</span>
                    </div>
                </a>
